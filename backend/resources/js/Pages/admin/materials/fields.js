...
export function materialFields(materialTypes, unitsOfMeasure = []) {
    return [
        ...
        },
        {
            ...
            options: unitsOfMeasure.map((unit) => ({
                value: unit.code,
                label: `${unit.symbol || unit.code} — ${unit.name}`,
            })),
            help: __('Quantity precision is defined by the selected unit.'),
        },
