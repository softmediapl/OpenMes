...
class SettingsController extends Controller
{
    ...
    public function updateSystemSettings(UpdateSystemSettingsRequest $request)
    {
        ...
        $map = [
            ...
            'forecast_alerts_enabled' => (bool) $validated['forecast_alerts_enabled'],
            'forecast_refresh_interval_minutes' => (int) $validated['forecast_refresh_interval_minutes'],
            'forecast_unplanned_downtime_minutes' => (int) $validated['forecast_unplanned_downtime_minutes'],
            'forecast_at_risk_slack_minutes' => (int) $validated['forecast_at_risk_slack_minutes'],
            'forecast_variance_alert_minutes' => (int) $validated['forecast_variance_alert_minutes'],
            'forecast_alert_recovery_margin_minutes' => (int) $validated['forecast_alert_recovery_margin_minutes'],
    ...
    private function settingsCatalog(\Illuminate\Support\Collection $rows): array
    {
        $managed = [
            ...
            'forecast_alerts_enabled' => 'Schedule tab',
            'forecast_refresh_interval_minutes' => 'Schedule tab',
            'forecast_unplanned_downtime_minutes' => 'Schedule tab',
            'forecast_at_risk_slack_minutes' => 'Schedule tab',
            'forecast_variance_alert_minutes' => 'Schedule tab',
            'forecast_alert_recovery_margin_minutes' => 'Schedule tab',
        ...
        $editable = [
            ...
            'forecast_alert_recovery_margin_minutes', 'forecast_alerts_enabled',
            'forecast_at_risk_slack_minutes', 'forecast_refresh_interval_minutes',
            'forecast_unplanned_downtime_minutes', 'forecast_variance_alert_minutes',
