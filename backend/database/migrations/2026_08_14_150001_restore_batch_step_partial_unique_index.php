...
/**
 * SQLite rebuilds batch_steps while adding operation timing columns and drops
 * the soft-delete predicate from its unique index. Restore the canonical index.
 */
